    ...
    <div className="min-h-screen bg-white text-[#0F172A] selection:bg-[#7C3AED]/20 selection:text-[#7C3AED] font-sans">
        ...
        <div className="max-w-7xl mx-auto px-5 lg:px-10 relative">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4">
              <AnimatedCtaButton
                href="/contact"
                label="Book a Logistics Consultation"
            ...
            <div>
              ...
              <div className="space-y-8">
                ...
                <div>
                  ...
                  <div className="flex gap-2 flex-wrap">
                    {["OpenAI", "Computer Vision", "Google Maps API", "Mapbox", "GPS Tracking APIs", "Twilio", "Barcode & RFID"].map(t => <span key={t} className="px-3 py-1.5 bg-white/5 border border-white/10 rounded-lg text-sm font-semibold text-white/80">{t}</span>)}
                  </div>
                </div>
                <div>
      ...
      <section className="py-16 md:py-24 bg-slate-50 relative overflow-hidden border-t border-slate-200">
        ...
        <div className="max-w-4xl mx-auto px-5 text-center relative z-10">
          ...
          <AnimatedCtaButton
            href="/contact"
            label="Build Your Logistics Platform"
            hoverLabel="Let's Talk Business"
            size="lg"
            className="mx-auto"
          />
          ...
          <div className="grid md:grid-cols-3 gap-12">
            <div>
              ...
              <ul className="space-y-4">
                <li><a href="#" className="text-slate-600 hover:text-[#7C3AED] transition-colors font-medium">Transportation Management System (TMS)</a></li>
                <li><a href="#" className="text-slate-600 hover:text-[#7C3AED] transition-colors font-medium">Warehouse Management System (WMS)</a></li>
                <li><a href="#" className="text-slate-600 hover:text-[#7C3AED] transition-colors font-medium">Fleet Management Platform</a></li>
                <li><a href="#" className="text-slate-600 hover:text-[#7C3AED] transition-colors font-medium">Dispatch Management System</a></li>
                <li><a href="#" className="text-slate-600 hover:text-[#7C3AED] transition-colors font-medium">Shipment Tracking Platform</a></li>
                <li><a href="#" className="text-slate-600 hover:text-[#7C3AED] transition-colors font-medium">Logistics Analytics Dashboard</a></li>
              </ul>
            </div>
            <div>
