    ...
    <div className="min-h-screen bg-white text-[#0F172A] selection:bg-[#7C3AED]/20 selection:text-[#7C3AED] font-sans">
            ...
            <div>
              ...
              <div className="space-y-8">
                ...
                <div>
                  ...
                  <div className="flex gap-2 flex-wrap">
                    {["OpenAI", "Claude", "Gemini", "LangChain", "LangGraph", "Stripe", "Razorpay"].map(t => <span key={t} className="px-3 py-1.5 bg-white/5 border border-white/10 rounded-lg text-sm font-semibold text-white/80">{t}</span>)}
                  </div>
                </div>
                <div>
                  <h4 className="text-xs font-bold text-white/40 uppercase tracking-widest mb-3">Cloud & Analytics</h4>
                  <div className="flex gap-2 flex-wrap">
                    {["AWS", "Azure", "Docker", "Kubernetes", "PostHog", "Google Analytics", "Mixpanel"].map(t => <span key={t} className="px-3 py-1.5 bg-white/5 border border-white/10 rounded-lg text-sm font-semibold text-white/80">{t}</span>)}
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-16 md:py-24 bg-[#0F172A] text-white relative overflow-hidden border-t border-white/10">
        ...
        <div className="max-w-5xl mx-auto px-5 lg:px-10 text-center relative z-10">
          ...
          <h2 className="text-3xl md:text-4xl font-extrabold mb-10 text-white">Startup Metrics We Optimize For</h2>
          ...
          <div className="grid md:grid-cols-3 gap-12">
            <div>
              ...
              <ul className="space-y-4">
                <li><a href="#" className="text-slate-600 hover:text-[#7C3AED] transition-colors font-medium">MVP Development</a></li>
                <li><a href="#" className="text-slate-600 hover:text-[#7C3AED] transition-colors font-medium">SaaS Platform Development</a></li>
                <li><a href="#" className="text-slate-600 hover:text-[#7C3AED] transition-colors font-medium">AI Product Development</a></li>
                <li><a href="#" className="text-slate-600 hover:text-[#7C3AED] transition-colors font-medium">Customer Portal</a></li>
                <li><a href="#" className="text-slate-600 hover:text-[#7C3AED] transition-colors font-medium">Admin Dashboard</a></li>
                <li><a href="#" className="text-slate-600 hover:text-[#7C3AED] transition-colors font-medium">Analytics Platform</a></li>
              </ul>
            </div>
            <div>
              <h4 className="text-lg font-bold mb-6 text-slate-900">Related Services</h4>
              <ul className="space-y-4">
                <li><a href="#" className="text-slate-600 hover:text-[#7C3AED] transition-colors font-medium">Product Strategy</a></li>
                ...
                <li><a href="#" className="text-slate-600 hover:text-[#7C3AED] transition-colors font-medium">UI/UX Design</a></li>
              </ul>
            </div>
            <div>
              ...
              <ul className="space-y-4">
                ...
                <li><a href="/industries/real-estate" className="text-slate-600 hover:text-[#7C3AED] transition-colors font-medium">Real Estate</a></li>
