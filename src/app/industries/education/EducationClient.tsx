              ...
              <a href="/contact" className="group relative w-full sm:w-auto pl-6 pr-2 py-2 h-[56px] rounded-full bg-[#7C3AED] text-white font-bold hover:bg-[#6D28D9] hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center justify-between gap-4 shadow-xl shadow-[#7C3AED]/20 overflow-hidden">
                <div className="relative h-6 w-[230px] overflow-hidden flex items-center">
                  <span className="absolute inset-0 flex items-center transition-transform duration-300 group-hover:-translate-y-full text-left whitespace-nowrap">
                    Book an Education Consultation
                  </span>
            ...
            <div>
              ...
              <div className="space-y-8">
                ...
                <div>
                  ...
                  <div className="flex gap-2 flex-wrap">
                    {["OpenAI", "Claude", "Gemini", "Zoom", "Google Meet", "Microsoft Teams", "Stripe"].map(t => <span key={t} className="px-3 py-1.5 bg-slate-800 rounded-lg text-sm font-semibold">{t}</span>)}
                  </div>
                </div>
                <div>
      ...
      <section className="py-24 bg-slate-50 relative overflow-hidden border-t border-slate-200">
        ...
        <div className="max-w-4xl mx-auto px-5 text-center relative z-10">
          ...
          <a href="/contact" className="group relative w-full sm:w-auto pl-6 pr-2 py-2 h-[64px] rounded-full bg-[#7C3AED] text-white font-bold hover:bg-[#6D28D9] hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center justify-between gap-4 shadow-xl shadow-[#7C3AED]/20 overflow-hidden mx-auto inline-flex">
            <div className="relative h-6 w-[210px] overflow-hidden flex items-center justify-center text-lg">
          ...
          <div className="grid md:grid-cols-3 gap-12">
            <div>
              ...
              <ul className="space-y-4">
                <li><a href="#" className="text-slate-600 hover:text-blue-600 transition-colors font-medium">Learning Management System (LMS)</a></li>
                <li><a href="#" className="text-slate-600 hover:text-blue-600 transition-colors font-medium">School ERP</a></li>
                <li><a href="#" className="text-slate-600 hover:text-blue-600 transition-colors font-medium">Student Information System</a></li>
                <li><a href="#" className="text-slate-600 hover:text-blue-600 transition-colors font-medium">Online Examination Platform</a></li>
                <li><a href="#" className="text-slate-600 hover:text-blue-600 transition-colors font-medium">AI Learning Assistant</a></li>
                <li><a href="#" className="text-slate-600 hover:text-blue-600 transition-colors font-medium">Education Analytics Dashboard</a></li>
              </ul>
            </div>
            <div>
            ...
            <div>
              ...
              <ul className="space-y-4">
                ...
                <li><a href="/industries/hr" className="text-slate-600 hover:text-blue-600 transition-colors font-medium">HR & Recruitment</a></li>
                <li><a href="/industries/corporate-training" className="text-slate-600 hover:text-blue-600 transition-colors font-medium">Corporate Training</a></li>
              </ul>
            </div>
          </div>
        </div>
