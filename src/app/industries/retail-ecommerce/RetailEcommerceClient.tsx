          ...
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-16">
            ...
            <div>
              ...
              <div className="space-y-8">
                ...
                <div>
                  <h4 className="text-xs font-bold text-white/40 uppercase tracking-widest mb-3">Commerce & Payments</h4>
                  <div className="flex gap-2 flex-wrap">
                    {["Shopify", "WooCommerce", "Medusa.js", "Commerce Layer", "Stripe", "Razorpay", "PayPal", "Cashfree"].map(t => <span key={t} className="px-3 py-1.5 bg-white/5 border border-white/10 rounded-lg text-sm font-semibold text-white/80">{t}</span>)}
                  </div>
                </div>
                <div>
          ...
          <div className="grid md:grid-cols-3 gap-12">
            <div>
              ...
              <ul className="space-y-4">
                <li><a href="#" className="text-slate-600 hover:text-[#7C3AED] transition-colors font-medium">AI Shopping Assistant</a></li>
                <li><a href="#" className="text-slate-600 hover:text-[#7C3AED] transition-colors font-medium">Inventory Management System</a></li>
                <li><a href="#" className="text-slate-600 hover:text-[#7C3AED] transition-colors font-medium">Retail ERP</a></li>
                <li><a href="#" className="text-slate-600 hover:text-[#7C3AED] transition-colors font-medium">Customer Loyalty Platform</a></li>
                <li><a href="#" className="text-slate-600 hover:text-[#7C3AED] transition-colors font-medium">CRM Solutions</a></li>
