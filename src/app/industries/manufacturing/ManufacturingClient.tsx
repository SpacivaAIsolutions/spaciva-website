...
export default function ManufacturingClient() {
  ...
  return (
    <div className="min-h-screen bg-white text-[#0F172A] selection:bg-[#7C3AED]/20 selection:text-[#7C3AED] font-sans">
        ...
        <div className="max-w-7xl mx-auto px-5 lg:px-10 relative">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4">
              <AnimatedCtaButton
                href="/contact"
                label="Book a Manufacturing Consultation"
              ...
              <div className="space-y-8">
                <div>
                  ...
                  <div className="flex gap-2 flex-wrap">
                    {["React", "Next.js", "Flutter"].map(t => <span key={t} className="px-3 py-1.5 bg-white/5 border border-white/10 rounded-lg text-sm font-semibold text-white/80">{t}</span>)}
                  </div>
                </div>
                <div>
                ...
                <div>
                  <h4 className="text-xs font-bold text-white/40 uppercase tracking-widest mb-3">AI & Computer Vision</h4>
                  <div className="flex gap-2 flex-wrap">
                    {["OpenAI", "LangChain", "TensorFlow", "PyTorch", "Computer Vision"].map(t => <span key={t} className="px-3 py-1.5 bg-white/5 border border-white/10 rounded-lg text-sm font-semibold text-white/80">{t}</span>)}
                  </div>
                </div>
                <div>
                  <h4 className="text-xs font-bold text-white/40 uppercase tracking-widest mb-3">Cloud & IoT</h4>
                  <div className="flex gap-2 flex-wrap">
                    {["AWS", "Azure", "Docker", "Kubernetes", "MQTT", "Modbus", "OPC UA"].map(t => <span key={t} className="px-3 py-1.5 bg-white/5 border border-white/10 rounded-lg text-sm font-semibold text-white/80">{t}</span>)}
                  </div>
                </div>
              </div>
            </div>
      ...
      {/* Manufacturing KPIs — dark base with a purple glow accent, matching the site's
          established closing-CTA treatment, instead of a flat off-brand blue band */}
      <section className="py-16 md:py-24 bg-[#0F172A] text-white relative overflow-hidden border-t border-white/10">
        ...
        <div className="max-w-5xl mx-auto px-5 lg:px-10 text-center relative z-10">
          ...
          <h2 className="text-3xl md:text-4xl font-extrabold mb-10 text-white">Manufacturing KPIs We Optimize</h2>
      ...
      <section className="py-16 md:py-24 bg-slate-50 relative overflow-hidden border-t border-slate-200">
        ...
        <div className="max-w-4xl mx-auto px-5 text-center relative z-10">
          ...
          <AnimatedCtaButton
            href="/contact"
            label="Schedule a Manufacturing Strategy Call"
            hoverLabel="Let's Talk Business"
            size="lg"
            className="mx-auto"
          />
          ...
          <div className="grid md:grid-cols-3 gap-12">
            <div>
              ...
              <ul className="space-y-4">
                <li><a href="#" className="text-slate-600 hover:text-[#7C3AED] transition-colors font-medium">Manufacturing ERP</a></li>
                <li><a href="#" className="text-slate-600 hover:text-[#7C3AED] transition-colors font-medium">Production Management</a></li>
                <li><a href="#" className="text-slate-600 hover:text-[#7C3AED] transition-colors font-medium">Inventory Management</a></li>
                <li><a href="#" className="text-slate-600 hover:text-[#7C3AED] transition-colors font-medium">AI Predictive Maintenance</a></li>
                <li><a href="#" className="text-slate-600 hover:text-[#7C3AED] transition-colors font-medium">Smart Factory Dashboard</a></li>
              </ul>
            </div>
            <div>
              <h4 className="text-lg font-bold mb-6 text-slate-900">Related Services</h4>
              <ul className="space-y-4">
                <li><a href="#" className="text-slate-600 hover:text-[#7C3AED] transition-colors font-medium">AI Development</a></li>
                ...
                <li><a href="#" className="text-slate-600 hover:text-[#7C3AED] transition-colors font-medium">Mobile Apps</a></li>
            ...
            <div>
              ...
              <ul className="space-y-4">
                <li><a href="/industries/logistics" className="text-slate-600 hover:text-[#7C3AED] transition-colors font-medium">Logistics</a></li>
                <li><a href="/industries/retail" className="text-slate-600 hover:text-[#7C3AED] transition-colors font-medium">Retail</a></li>
                <li><a href="/industries/automotive" className="text-slate-600 hover:text-[#7C3AED] transition-colors font-medium">Automotive</a></li>
