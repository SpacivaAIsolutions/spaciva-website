            ...
            <div>
              ...
              <div className="space-y-8">
                ...
                <div>
                  ...
                  <div className="flex gap-2 flex-wrap">
                    {["OpenAI", "Claude", "Stripe", "Razorpay", "Booking APIs", "Google Maps", "WhatsApp Business"].map(t => <span key={t} className="px-3 py-1.5 bg-white/5 border border-white/10 rounded-lg text-sm font-semibold text-white/80">{t}</span>)}
                  </div>
                </div>
                <div>
          ...
          <div className="grid md:grid-cols-3 gap-12">
            <div>
              ...
              <ul className="space-y-4">
                <li><a href="#" className="text-slate-600 hover:text-[#7C3AED] transition-colors font-medium">Hotel Management System</a></li>
                <li><a href="#" className="text-slate-600 hover:text-[#7C3AED] transition-colors font-medium">Property Management System</a></li>
                <li><a href="#" className="text-slate-600 hover:text-[#7C3AED] transition-colors font-medium">Online Booking Platform</a></li>
                <li><a href="#" className="text-slate-600 hover:text-[#7C3AED] transition-colors font-medium">Restaurant Management System</a></li>
                <li><a href="#" className="text-slate-600 hover:text-[#7C3AED] transition-colors font-medium">AI Concierge</a></li>
                <li><a href="#" className="text-slate-600 hover:text-[#7C3AED] transition-colors font-medium">Hospitality CRM</a></li>
              </ul>
            </div>
            <div>
