          ...
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-16">
            ...
            <div>
              ...
              <div className="space-y-8">
                <div>
                  <h4 className="text-xs font-bold text-white/40 uppercase tracking-widest mb-3">Frontend & Backend</h4>
                  <div className="flex gap-2 flex-wrap">
                    {["Next.js", "React", "Flutter", "Node.js", "Python", "Go", ".NET"].map(t => <span key={t} className="px-3 py-1.5 bg-white/5 border border-white/10 rounded-lg text-sm font-semibold text-white/80">{t}</span>)}
                  </div>
                </div>
                <div>
                  <h4 className="text-xs font-bold text-white/40 uppercase tracking-widest mb-3">IoT & Database</h4>
                  <div className="flex gap-2 flex-wrap">
                    {["MQTT", "OPC UA", "Modbus", "LoRaWAN", "PostgreSQL", "MongoDB", "InfluxDB"].map(t => <span key={t} className="px-3 py-1.5 bg-white/5 border border-white/10 rounded-lg text-sm font-semibold text-white/80">{t}</span>)}
                  </div>
                </div>
                <div>
          ...
          <div className="grid md:grid-cols-3 gap-12">
            <div>
              ...
              <ul className="space-y-4">
                <li><a href="#" className="text-slate-600 hover:text-[#7C3AED] transition-colors font-medium">Energy Management System (EMS)</a></li>
                <li><a href="#" className="text-slate-600 hover:text-[#7C3AED] transition-colors font-medium">Utility Billing Platform</a></li>
                <li><a href="#" className="text-slate-600 hover:text-[#7C3AED] transition-colors font-medium">Smart Grid Platform</a></li>
                <li><a href="#" className="text-slate-600 hover:text-[#7C3AED] transition-colors font-medium">Asset Management System</a></li>
                <li><a href="#" className="text-slate-600 hover:text-[#7C3AED] transition-colors font-medium">Field Workforce Management</a></li>
            ...
            <div>
              ...
              <ul className="space-y-4">
                ...
                <li><a href="#" className="text-slate-600 hover:text-[#7C3AED] transition-colors font-medium">IoT Integration</a></li>
            ...
            <div>
              ...
              <ul className="space-y-4">
                <li><a href="/industries/manufacturing" className="text-slate-600 hover:text-[#7C3AED] transition-colors font-medium">Manufacturing</a></li>
